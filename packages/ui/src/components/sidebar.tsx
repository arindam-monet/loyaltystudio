  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 h-svh w-(--sidebar-width) transition-[width] duration-200 ease-linear md:relative md:flex",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "[&>header]:sticky [&>header]:top-0 [&>header]:z-10 [&>header]:bg-background",
        className
      )}
      {...props}
    />
